<h2><a href="https://leetcode.com/problems/is-subsequence/description/">393. UTF-8 Validation</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>data</code> representing the data, return whether it is a valid <strong>UTF-8</strong> encoding (i.e. it translates to a sequence of valid UTF-8 encoded characters).</p>
