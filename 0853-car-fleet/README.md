<h2><a href="https://leetcode.com/problems/k-similar-strings/description/">883. Car Fleet</a></h2><h3>Medium</h3><hr><p>There are <code>n</code> cars at given miles away from the starting mile 0, traveling to reach the mile <code>target</code>.</p>
